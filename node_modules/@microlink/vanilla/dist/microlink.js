(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('react-dom'), require('styled-components'), require('@microlink/mql')) :
  typeof define === 'function' && define.amd ? define(['react', 'react-dom', 'styled-components', '@microlink/mql'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.microlink = factory(global.React, global.ReactDOM, global.styled, global.mql));
})(this, (function (React, ReactDOM, styledComponents, mql) { 'use strict';
  ...
  const StyledClamp = styledComponents(Clamp)(_templateObject$h || (_templateObject$h = _taggedTemplateLiteral(["\n  &&& {\n    text-align: inherit;\n    font-weight: inherit;\n    font-family: inherit;\n    color: inherit;\n    margin: 0;\n\n    ", "\n  }\n"])), _ref2 => {
    let {
      $useNanoClamp
    } = _ref2;
  ...
  const Content = styledComponents('div').attrs({
  ...
  const Header = styledComponents('header').attrs({
  ...
  const Description = styledComponents('div').attrs({
  ...
  const Footer = styledComponents('footer').attrs({
  ...
  const Author = styledComponents(CardText)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  opacity: 0.75;\n  transition: ", ";\n  will-change: opacity;\n\n  .", ":hover & {\n    opacity: 1;\n  }\n"])), transition.medium('opacity'), classNames.main);
  const PoweredBy = styledComponents('span').attrs({
    title: 'microlink.io'
  ...
  const ImageLoadCatcher = styledComponents('img')(_templateObject$e || (_templateObject$e = _taggedTemplateLiteral(["\n  height: 1px;\n  width: 1px;\n  position: absolute;\n  z-index: -1;\n"])));
  ...
  const StyledWrap = styledComponents('div')(_templateObject5$5 || (_templateObject5$5 = _taggedTemplateLiteral(["\n  background: transparent no-repeat center center / cover;\n  display: block;\n  overflow: hidden;\n  height: auto;\n  position: relative;\n\n  &::before {\n    content: '';\n    padding-bottom: 100%;\n    display: block;\n  }\n\n  ", ";\n\n  ", ";\n"])), _ref => {
    let {
      $cardSize
    } = _ref;
  ...
  const ImageWrap = styledComponents(Wrap$1).attrs({
  ...
  const MediaEmpty = styledComponents(ImageComponent)(_templateObject$b || (_templateObject$b = _taggedTemplateLiteral(["\n  ", ";\n"])), emptyStateImageAnimation);
  const HeaderEmpty = styledComponents('span')(_templateObject2$8 || (_templateObject2$8 = _taggedTemplateLiteral(["\n  opacity: 0.8;\n  height: 16px;\n  width: ", ";\n  display: block;\n  background: #e1e8ed;\n  margin: ", ";\n  ", ";\n\n  ", ";\n"])), _ref => {
    let {
      $cardSize
    } = _ref;
  ...
  const DescriptionEmpty = styledComponents('span')(_templateObject3$7 || (_templateObject3$7 = _taggedTemplateLiteral(["\n  opacity: 0.8;\n  height: 14px;\n  width: 95%;\n  display: block;\n  position: relative;\n  ", ";\n  animation-delay: 0.125s;\n"])), emptyStateAnimation);
  const FooterEmpty = styledComponents('span')(_templateObject4$6 || (_templateObject4$6 = _taggedTemplateLiteral(["\n  opacity: 0.8;\n  height: 12px;\n  width: 30%;\n  display: block;\n  ", " animation-delay: .25s;\n\n  ", ";\n"])), emptyStateAnimation, _ref4 => {
    let {
      $cardSize
    } = _ref4;
    return !isLarge($cardSize) && "\n    height: 10px;\n  ";
  ...
  const MediaButton = styledComponents('div')(_templateObject$a || (_templateObject$a = _taggedTemplateLiteral(["\n  backface-visibility: hidden;\n  filter: drop-shadow(0 2px 4px rgba(0, 0, 0, 0.3));\n  transition: ", ";\n  will-change: transform;\n\n  > svg {\n    display: block;\n  }\n\n  &:active:not(:focus) {\n    transform: scale(0.9);\n  }\n"])), transition.short('transform'));
  ...
  const BottomControls = styledComponents('div')(_templateObject$9 || (_templateObject$9 = _taggedTemplateLiteral(["\n  z-index: 2;\n  position: absolute;\n  bottom: ", "px;\n  left: 0;\n  right: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  transition: ", ";\n  will-change: opacity;\n"])), _ref => {
    let {
      $cardSize
    } = _ref;
    return isLarge($cardSize) ? 18 : 14;
  }, transition.medium('opacity'));
  const VolumeIcon = styledComponents('svg')(_templateObject2$7 || (_templateObject2$7 = _taggedTemplateLiteral(["\n  stroke: #fff;\n"])));
  const VolumeButton = styledComponents(MediaButton).attrs({
  ...
  const PlaybackRateButton = styledComponents(MediaButton).attrs({
  ...
  const TimeLabel = styledComponents('span').attrs({
  ...
  const PlaybackIcon = styledComponents('svg')(_templateObject$8 || (_templateObject$8 = _taggedTemplateLiteral(["\n  stroke: #fff;\n"])));
  const PlaybackButtonWrap = styledComponents(MediaButton).attrs({
  ...
  const Scrubber = styledComponents('div').attrs(_ref => {
    let {
      isVisible,
      positionX
    } = _ref;
  ...
  const TooltipBase = styledComponents('span').attrs(_ref => {
    let {
      position,
      isDragging,
      visible
  ...
  const OuterWrap$1 = styledComponents('div').attrs(() => ({
    className: classNames.progressBar
  }))(_templateObject$5 || (_templateObject$5 = _taggedTemplateLiteral(["\n  position: relative;\n  padding: ", "px ", "px ", "px;\n  z-index: 2;\n  backface-visibility: hidden;\n"])), PADDING, PADDING / 2, PADDING / 2);
  const BarsWrap = styledComponents('div').attrs(_ref => {
    let {
      $cardSize,
      isDragging
    } = _ref;
  ...
  const ProgressLine = styledComponents('div')(_templateObject4$3 || (_templateObject4$3 = _taggedTemplateLiteral(["\n  border-radius: inherit;\n  height: 100%;\n  position: relative;\n  overflow: hidden;\n"])));
  const ProgressMask = styledComponents('div').attrs(_ref3 => {
    let {
      maskScale
    } = _ref3;
    return {
  ...
  const ProgressHover = styledComponents('div').attrs(_ref4 => {
    let {
      cursorRatio,
      isHovering,
      progressPercent
  ...
  const BufferedChunk = styledComponents('div').attrs(_ref5 => {
    let {
      start,
      end
    } = _ref5;
  ...
  const SeekIcon = styledComponents('svg')(_templateObject$4 || (_templateObject$4 = _taggedTemplateLiteral(["\n  stroke: #fff;\n  width: ", "px;\n  height: ", "px;\n\n  ", "\n"])), _ref3 => {
    let {
      $cardSize
    } = _ref3;
  ...
  const SeekButtonWrap = styledComponents(MediaButton)(_templateObject3$3 || (_templateObject3$3 = _taggedTemplateLiteral(["\n  margin: 0 ", ";\n"])), _ref6 => {
    let {
      $cardSize
    } = _ref6;
  ...
  const Wrap = styledComponents(MediaButton).attrs(_ref => {
    let {
      isVisible
    } = _ref;
    return {
  ...
  const Svg = styledComponents('svg')(_templateObject4$2 || (_templateObject4$2 = _taggedTemplateLiteral(["\n  width: 100%;\n  animation: ", " 2s linear infinite;\n  will-change: transform;\n"])), rotate);
  const Circle = styledComponents('circle')(_templateObject5$2 || (_templateObject5$2 = _taggedTemplateLiteral(["\n  stroke: #fff;\n  stroke-linecap: round;\n  stroke-width: 7;\n  fill: none;\n  animation: ", " 1.5s ease-in-out infinite;\n  will-change: stroke-dasharray, stroke-dashoffset;\n"])), dash);
  const Spinner = _ref3 => {
    let {
      size,
      isVisible
  ...
  const M_KEY = 77;
  const OuterWrap = styledComponents('div').attrs({
  ...
  const InnerWrap = styledComponents('div')(_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteral(["\n  position: absolute;\n  left: 0;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  z-index: 2;\n"])));
  const ControlsTop = styledComponents('div')(_templateObject4$1 || (_templateObject4$1 = _taggedTemplateLiteral(["\n  flex: 1;\n\n  ", "\n"])), _ref2 => {
    let {
      isVisible
    } = _ref2;
  ...
  const VideoDOM = styledComponents('video')(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["\n  width: 100%;\n  height: 100%;\n  object-fit: cover;\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n\n  &::media-controls-start-playback-button {\n    display: none;\n    appearance: none;\n  }\n"])));
  const Video = props => {
    const {
      state: {
        imageUrl,
  ...
  const Element = styledComponents('a')(baseStyle, _ref3 => {
    let {
      $isLoading,
      contrast
    } = _ref3;
